            ...
            <div class="row">
              <div class="col-sm-6 col-xs-6">
                <div class="description-block border-right">
                  <h2 class="description-header"><?php echo currency_format(get_bank_deposit_amount(date('d-m-Y'), date('d-m-Y')));?></h2>
                  <h4 class="description-text"><?php echo trans('text_deposit_today'); ?></h4>
                </div>
              </div>
              <div class="col-sm-6 col-xs-6">
                <div class="description-block border-right">
                  <h2 class="description-header"><?php echo currency_format(get_bank_withdraw_amount(date('d-m-Y'), date('d-m-Y')));?></h2>

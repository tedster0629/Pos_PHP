...
if ($request->server['REQUEST_METHOD'] == 'POST' && $request->get['action_type'] == "LOGIN")
{
  try {
    ...
    // Check total try
    $from = date('d-m-Y H:i:s', strtotime('-'.(int)UNLOCK_ACCOUNT_AFTER.' minutes', time()));
    $to = date('d-m-Y H:i:s'); 
    $ip = get_real_ip();
  ...
  <section class="login-box">
    ...
    <div class="login-box-body" ng-controller="LoginController">
      ...
      <form id="login-form" action="login.php" method="post">       
        ...
        <button type="submit" id="login-btn" class="btn btn-success btn-block btn-flat" data-loading-text="Iniciando...">
    ...
    <div class="copyright text-center">
      <p>&copy; <a href="https://magnetworkingchile.cl/">Magnetworking Solutions</a>, v<?php echo settings('version'); ?></p>
    </div>
  </section>
